# question_data is a list and there are 12 dictionaries inside that list
# we can use open tribia website to make more question 
# there will be api documentation and select levels from there
# a link will Generate open the lin in another tab
# then you will see a jason file  which is similar to a dictionary
