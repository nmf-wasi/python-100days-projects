# previous one is better tbh
#if you dont wanna print result, then it's easier to use
rock = '''
    _______
---'   ____)
      (_____)
...
drawingOptions=[rock,paper,scissors]

hooman_art=drawingOptions[hooman_option_choice]
com_art=drawingOptions[com_option_choice]
...
if(hooman_option_choice==2 and com_option_choice==0):
    print("Computer wins!")
elif(hooman_option_choice==0 and com_option_choice==2):
    print("You win!")
elif(hooman_option_choice>com_option_choice):
    print("You win!")
elif(hooman_option_choice<com_option_choice):
    print("Computer wins!")
